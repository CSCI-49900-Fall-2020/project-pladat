                                    ...
                                    <table class="main_table" valign="middle" style="width: 100% !important; max-width: 100% !important;">
                                        <tbody style="width: 100% !important;">
                                            ...
                                            <tr class="head_section">
                                                <td class="head_section_td upper"><h1>PlaceMint</h1></td>
                                            </tr>
                                                ...
                                                <td class="body_section_td upper">
                                                        ...
                                                        <a id="buttonLink" style="cursor:pointer; outline: none; text-decoration: none;" href="${link}">
                                                            <button id="verifyEmailButton" style="font-weight: 300; font-family: 'Montserrat', sans-serif;
                                                                ...
                                                                height: 50px;
                                                                width: 20%;
                                                                background: rgb(188, 246, 240);
                                                                border: 2px solid rgb(188, 246, 240);
                                                                border-radius: 4px;
                                                                color: rgb(20, 20, 20);
                                                                font-size: 17px;
                                                                outline: none; 
                                                        ...
                                                        <a id="textLink" style="color: rgb(188, 246, 240); text-decoration: underline; outline: #7DE2FC; cursor: pointer;" href="${link}">
                                                            <h3 style="font-weight: 300; text-overflow: ellipsis;">Verification Link (CLICK ME)</h3>
                                                        </a> <br>
